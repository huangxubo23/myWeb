...
var temp = { map: {}, control: { nav: new BMap.NavigationControl(), ove: new BMap.OverviewMapControl(), sca: new BMap.ScaleControl()} };
...
function getlikeArea() {
    if (typeof (l_search) == "undefined") {
        l_option = { onSearchComplete: function (e) {
...
_sign.mapSign = { pointInfo: { list: {} }, polylineInfo: { list: {} }, remarkInfo: { list: {}} };
...
function Sign() {
    ...
    this.tabDom = null;
    this.tabIndex;
    this.followInfo = { point: "左键标记，右键退出", polyline: "左键单击开始画线，双击结束画线，右键退出", remark: "左键标记，右键退出" };
    this.temp = { event: { polyline: [], followTip: [] }, polyline: {} };
    return ""
}
Sign.inherits(Fe.BaseClass, "Sign");
Fe.extend(Sign.prototype, { openPoint: function () {
    var a = this;
    ...
    var c = function (p) {
        ...
        if (!b) {
            var o = _gl.config.pl;
            var m = { strokeColor: o.color, strokeWeight: o.weight, strokeOpacity: o.opacity, strokeStyle: o.style };
            var n = null;
    ...
    var e = function (o) {
        if (h.length > 1) {
            ...
            b.enableEditing();
            _sign.mapSign.polylineInfo.list[k] = { polyobj: b, arr: h, color: m.color, _color: m.color, weight: m.weight, _weight: m.weight, opacity: m.opacity, _opacity: m.opacity, style: m.style, _style: m.style };
    ...
    Fe.on(j, "mousemove", a);
    Fe.on(j, "dblclick", e);
    f.temp.event.polyline.push({ elem: j, type: "click", func: c }, { elem: j, type: "mousemove", func: a }, { elem: j, type: "dblclick", func: e })
    ...
    if (d.followInfo[b]) {
        var a;
        if (!d.followTitle) {
            a = d.followTitle = new BMap.Label(d.followInfo[b], { offset: new BMap.Size(0, 0) })
        }
        a = d.followTitle;
        ...
        a.setStyle({ color: "#333", borderColor: "#ff0103" });
        ...
        d.temp.event.followTip.push({ elem: document, type: "mousemove", func: e }, { elem: document, type: "click", func: c })
    }
...
function MapSign() {
    ...
    _gl = this;
    this.oSign = null;
    this.temp = { iw: { change: 0, previous: null }, pl: { index: 0, previous: null, change: 0 }, lb: { index: 0, previous: null, change: 0 }, cur: { label: null, index: 11 }, icon: null, curSignType: null, preSignType: null, signclickTrue: 0, event: { showCurLab: []} };
    this.poiMarker = {};
    this.config = { iw: { index: 0, toal: 0, lagerT: 10, title: "我的标记", content: "我的备注", cityCode: 1, fav: 0, save: 0, show: 0 }, pl: { index: 0, toal: 0, lagerT: 10, color: "#f00", weight: 4, opacity: 0.6, style: "solid" }, lb: { index: 0, toal: 0, lagerT: 10, content: "我的标记", label: {} }, cur: { 11: { _w: 12, w: 21, h: 21, l: 0, t: 0, x: 6, y: 21, lb: 5 }, 12: { _w: 12, w: 21, h: 21, l: 23, t: 0, x: 6, y: 21, lb: 5 }, 13: { _w: 12, w: 21, h: 21, l: 46, t: 0, x: 6, y: 21, lb: 5 }, 14: { _w: 12, w: 21, h: 21, l: 69, t: 0, x: 6, y: 21, lb: 5 }, 15: { _w: 12, w: 21, h: 21, l: 92, t: 0, x: 6, y: 21, lb: 5 }, 16: { _w: 12, w: 21, h: 21, l: 115, t: 0, x: 6, y: 21, lb: 5 }, 21: { _w: 19, w: 23, h: 25, l: 0, t: 21, x: 9, y: 25, lb: 12 }, 22: { _w: 19, w: 23, h: 25, l: 23, t: 21, x: 9, y: 25, lb: 12 }, 23: { _w: 19, w: 23, h: 25, l: 46, t: 21, x: 9, y: 25, lb: 12 }, 24: { _w: 19, w: 23, h: 25, l: 69, t: 21, x: 9, y: 25, lb: 12 }, 25: { _w: 19, w: 23, h: 25, l: 92, t: 21, x: 9, y: 25, lb: 12 }, 26: { _w: 19, w: 23, h: 25, l: 115, t: 21, x: 9, y: 25, lb: 12 }, 31: { _w: 17, w: 21, h: 21, l: 0, t: 46, x: 1, y: 21, lb: 10 }, 32: { _w: 17, w: 21, h: 21, l: 23, t: 46, x: 1, y: 21, lb: 10 }, 33: { _w: 17, w: 21, h: 21, l: 46, t: 46, x: 1, y: 21, lb: 10 }, 34: { _w: 17, w: 21, h: 21, l: 69, t: 46, x: 1, y: 21, lb: 10 }, 35: { _w: 17, w: 21, h: 21, l: 92, t: 46, x: 1, y: 21, lb: 10 }, 36: { _w: 17, w: 21, h: 21, l: 115, t: 46, x: 1, y: 21, lb: 10}} };
    this.favTime = ""
}
MapSign.inherits(Fe.BaseClass, "MapSign");
Fe.extend(MapSign.prototype, { createMark: function (j) {
    ...
    var f = new BMap.Marker(b, { enableMassClear: false, icon: h });
    var c = null;
    f.addEventListener("click", function () {
        _gl.openInfoWnd(this, i, { type: "marker" })
    });
    ...
    var l = new BMap.Label(m, { offset: new BMap.Size(d._w - d.x + 3, -20) });
    f.setLabel(l);
    var o = null;
    ...
    l.addEventListener("click", function () {
        _gl.openInfoWnd(_gl.poiMarker[i], i, { type: "marker" })
    });
    map.addOverlay(f);
    l.setStyle({ borderColor: "#808080", color: "#333", cursor: "pointer" });
    f.setTitle("可移动改变位置");
    if (!_sign.mapSign.pointInfo.list[i]) {
        _sign.mapSign.pointInfo.list[i] = { marker: f, point: b.lng + "|" + b.lat, title: m, _title: m, content: k, _content: k, cityCode: n, fav: g, save: save, show: p, cur: q, _cur: q };
        _gl.poiMarker[i] = f
    }
    _gl.temp.iw.index = i;
    _gl.temp.iw.pre = i;
    ...
    editSignList("iw", e, { type: "map" });
    _gl.temp.iw.index = e;
    b.show = 1;
    var a = b.point.split("|")[0];
    var g = b.point.split("|")[1];
    var f = function () {
        var i = _gl.createInfoWnd({ userSign: 1, title: b._title, content: b._content, index: e, fav: b.fav }, { cityCode: b.cityCode, x: a, y: g });
        return i
    };
    var d = f();
    c.openInfoWindow(d)
    ...
    var b = new BMap.Icon("images/us_mk_icon.png", new BMap.Size(c.w, c.h), { imageOffset: new BMap.Size(-c.l, -c.t), infoWindowOffset: new BMap.Size(c.lb + 5, 1) });
    _gl.temp.icon = b;
    return b
}, showCurLab: function () {
    var c;
    if (!_gl.temp.cur.label) {
        c = _gl.temp.cur.label = new BMap.Marker(map.getCenter(), new BMap.Icon("images/us_cursor.gif"));
    ...
    _gl.temp.event.showCurLab.push({ elem: document, type: "mousemove", func: f }, { elem: document, type: "click", func: e })
    ...
    var b = new BMap.Label("", { offset: new BMap.Size(3, -7), point: a, enableMassClear: false });
    var g = null;
    b.addEventListener("click", function () {
        editSignList("lb", c)
    });
    ...
    map.addOverlay(b);
    b.setStyle({ border: "1px solid #999" });
    _sign.mapSign.remarkInfo.list[_gl.config.lb.index] = { point: a.lng + "|" + a.lat, content: d, _content: d, type: 0 };
    _gl.config.lb.label[_gl.config.lb.index] = { label: b };
    _gl.config.lb.index++;
    _gl.config.lb.toal++
...
function createSearchInfoWnd(e, d) {
    ...
    var a = new BMap.InfoWindow(b, { title: f, height: 0, margin: [10, 10, 20, 10] });
    return a
}
...
function editSignList(b, e, d) {
    ...
    if (b == "iw" && d == "list") {
        _gl.openInfoWnd(a.marker, e, { type: "marker" })
    }
}
...
function stringEscape(a) {
    return a.replace(/<(script|link|style|iframe)(.|\n|\s)*/ig, "")
}
...
function gotoBestMap(f, d) {
    ...
    map.setViewport(b, { zoomFactor: g })
}
...
function showSignCode() {
    ...
    M.fe.copy({ copyBtnId: "copy_code", copytextId: "bareasign", copyTag: "value", callback: function (f) {
...
if (document.all) {
    Fe.on(window, "load", function () {
        ...
        var d = [{ value: c.nav.place, cl_type: "nav" }, { value: c.ove.place, cl_type: "ove" }, { value: c.sca.place, cl_type: "sca"}];
        var a = [{ value: c.nav.style, cl_type: "nav" }, { value: c.sca.style, cl_type: "sca"}];
